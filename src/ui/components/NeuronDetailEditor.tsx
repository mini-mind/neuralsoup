...
const NeuronDetailEditor: React.FC<NeuronDetailEditorProps> = ({
  neuron,
  onUpdate,
}) => {
  const [label, setLabel] = useState(neuron.label);
  const [params, setParams] = useState(
    neuron.params || { a: 0.02, b: 0.2, c: -65, d: 8, threshold: 30 },
  );
  ...
  return (
    <div style={{ padding: "0" }}>
      ...
      <div style={{ marginBottom: "16px" }}>
        <h6
          style={{ margin: "0 0 8px 0", fontSize: "0.9rem", fontWeight: 600 }}
        >
          当前状态:
        </h6>
        <div
        ...
        >
          ...
          >
            ...
            <input
              ...
              value={params.a}
              onChange={(e) =>
                handleParamChange("a", parseFloat(e.target.value) || 0)
              }
              style={{
                width: "100%",
                padding: "4px 6px",
          ...
          >
            ...
            <input
              ...
              value={params.b}
              onChange={(e) =>
                handleParamChange("b", parseFloat(e.target.value) || 0)
              }
              style={{
                width: "100%",
                padding: "4px 6px",
          ...
          >
            ...
            <input
              ...
              value={params.c}
              onChange={(e) =>
                handleParamChange("c", parseFloat(e.target.value) || 0)
              }
              style={{
                width: "100%",
                padding: "4px 6px",
          ...
          >
            ...
            <input
              ...
              value={params.d}
              onChange={(e) =>
                handleParamChange("d", parseFloat(e.target.value) || 0)
              }
              style={{
                width: "100%",
                padding: "4px 6px",
          ...
          >
            ...
            <input
              ...
              onChange={(e) =>
                handleParamChange("threshold", parseFloat(e.target.value) || 30)
              }
              style={{
                width: "100%",
                padding: "4px 6px",
      ...
      >
        <strong>参数说明:</strong>
        <br />
        • a: 恢复速度 (0.02=常规, 0.1=快速)
        <br />
        • b: u对v的敏感度 (0.2=常规)
        <br />
        • c: 发放后重置的膜电位 (-65=常规)
        <br />• d: 发放后u的增量 (8=常规, 2=爆发型)
      </div>
    </div>
  );
};
