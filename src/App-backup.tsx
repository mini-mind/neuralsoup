...
import AgentParametersModal from "./components/AgentParametersModal";
import AgentParametersPanel from "./components/AgentParametersPanel";
import TabPanel from "./components/TabPanel";
import CodeEditor from "./components/CodeEditor";
import SettingsPanel from "./components/SettingsPanel";
import ScriptManagerDialog from "./components/ScriptManagerDialog";
...
const App: React.FC = () => {
  ...
  const [scriptDialogType, setScriptDialogType] = useState<"create" | "edit">(
    "create",
  );
  const [scriptDialogAction, setScriptDialogAction] = useState<
    "rename" | "delete"
  >("rename");
