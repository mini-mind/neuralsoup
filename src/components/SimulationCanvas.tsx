...
const SimulationCanvas: React.FC<SimulationCanvasProps> = ({
  ...
  useEffect(() => {
    ...
    if (!app) {
      ...
      console.log(
        "Canvas container children before:",
        canvasRef.current.children.length,
      );
      ...
      console.log(
        "Canvas container children after:",
        canvasRef.current.children.length,
      );
      console.log(
      ...
      console.log(
        "Creating simulation engine with world size:",
        fixedWorldWidth,
        fixedWorldHeight,
      );
      ...
      if (mainAgent) {
        ...
        if (
          isMobile &&
          typeof (newEngine as any).setMobileScale === "function"
        ) {
          // 根据实际视野范围计算合适的缩放比例
      ...
      if (
        isMobile &&
        engineRef.current &&
        typeof (engineRef.current as any).setMobileScale === "function"
      ) {
        ...
        console.log(
          "Updated mobile scale on resize:",
          optimalScale,
          "for vision range:",
          visionRange,
        );
